...
boruta.variable.imp_mor <- boruta.imp(morPo1Boruta)

sp_boxplot(boruta.variable.imp_mor, melted=T, xvariable = "Variable", yvariable = "Importance",
...
# calculate
# shapKsMor <- kernelshap(rfMor, dfShapMor[, -1], dfShapMor[1:100, ])
