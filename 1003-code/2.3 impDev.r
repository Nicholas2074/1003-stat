...
boruta.variable.imp_dev <- boruta.imp(devPo1Boruta)

sp_boxplot(boruta.variable.imp_dev, melted=T, xvariable = "Variable", yvariable = "Importance",
...
# calculate
# shapKsDev <- kernelshap(rfDev, dfShapDev[, -1], dfShapDev[1:100, ])
